...
namespace StoreManagement.Web.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ProductController : StoreManagement.Web.Controllers.ProductController
    {
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, StoreManagement.Web.ViewModels.Product.AddProductViewModel viewModel);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(StoreManagement.Web.ViewModels.Product.AddProductViewModel viewModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
